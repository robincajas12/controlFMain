...
/**
 * Puebla la base de datos con un conjunto de datos de referencia
 * (configuración, usuarios, políticos, leyes, promesas, vínculos de
 * coherencia y contenido social) para tener un entorno navegable sin
 * depender de la fuente de datos externa.
 */
@Service
...
public class DataSeederService {
    ...
    /**
     * Inserta el conjunto de datos de referencia si la base de datos está
     * vacía. No hace nada si ya existen políticos registrados, para evitar
     * duplicar los datos en ejecuciones sucesivas.
     */
    @Transactional
    public void seed() {
        if (politicoRepository.count() > 0) return;

        // Configuración: umbrales usados por el motor de coherencia para
        // clasificar el nivel de cumplimiento de una promesa.
       ...
       Politico p8 = new Politico(null, "ALEJANDRO LORENZO VANEGAS CORTÁZAR", "INDEPENDIENTE", "Asambleísta", "Guayas", "Legislativo", true, new BigDecimal("85000"), "Asambleísta Nacional.", null, null, null, null, null);
        ...
        // Leyes de referencia. El orden de los campos sigue el constructor
        // generado por @AllArgsConstructor de Ley: (id, titulo, codigo,
        // tipoExpediente, proponente, descripcionOriginal,
        // descripcionSimplificada, impactoSocial, categoria, estado,
        // fechaIngreso, externalId, votos, comentarios, calificaciones, vinculos).
        ...
        // Promesas de campaña de referencia.
        ...
        // Votos de referencia. La fecha de cada voto es la de ingreso de su
        // ley (la votación ocurre en esa sesión), no "ahora": así la serie
        // mensual refleja fechas reales y no se concentra todo en el mes actual.
        ...
        // Vínculos de coherencia entre promesas y leyes de referencia.
        ...
        // Contenido social de referencia (comentario ciudadano).
