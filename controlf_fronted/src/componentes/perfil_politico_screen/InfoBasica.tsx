    ...
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 mb-8">
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="flex-grow space-y-4">
          ...
          <div className="pt-4">
            <button className="flex items-center gap-2 px-6 py-2 bg-primary-navy text-white rounded-lg text-sm font-bold hover:bg-slate-800 transition-colors shadow-sm">
